    ...
    <section id="contact" class="section">
      <div class="container">
        ...
        <div class="grid-2" style="max-width: 1140px; margin-inline: auto; gap: var(--space-8); align-items: start;">
            ...
            <div class="double-bezel" style="margin-bottom: var(--space-8);">
              <div class="double-bezel-inner" style="padding: clamp(1.5rem, 3.5vw, 2.5rem);">
                ...
                <div class="flex flex-col gap-4">
                  ...
                  <a href="https://wa.me/?text=Hi%20Solonova%20Studio,%20I'd%20like%20to%20discuss%20a%20website%20sprint" target="_blank" rel="noopener noreferrer" class="btn btn-secondary btn-lg" style="justify-content: flex-start; background: #F0FDF4; border-color: #A7F3D0; color: #047857;">
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#059669" stroke-width="2.2">
                      <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path>
                    </svg>
                    <span><strong>Chat on WhatsApp</strong> (Instant Founder Reply)</span>
                  </a>

                  <!-- Email Direct -->
                  <a href="mailto:ben@solonova.ai" class="btn btn-secondary btn-lg" style="justify-content: flex-start;">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#09090B" stroke-width="2">
                      <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                      <polyline points="22,6 12,13 2,6"></polyline>
                    </svg>
                    <span>ben@solonova.ai</span>
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="double-bezel">
              <div class="double-bezel-inner" style="padding: clamp(1.25rem, 3vw, 2rem); background: #FAFAFB;">
                <div class="flex items-center gap-3" style="margin-bottom: var(--space-3);">
                  ...
                  <span style="font-family: var(--font-mono); font-size: 0.88rem; color: #09090B; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase;">
                    ACTIVE QUEUE · IST BENGALURU / MUMBAI
                  </span>
                </div>
                <p style="font-size: 0.98rem; color: #52525B; margin: 0; line-height: 1.65;">
          ...
          <div class="double-bezel">
            <div class="double-bezel-inner" style="padding: clamp(1.75rem, 3.5vw, 3rem);">
              <form id="inquiry-form">
                ...
                <div class="grid-2" style="gap: var(--space-4);">
                  <div class="input-group">
                    ...
                    <select id="contact-timeline" class="select-field">
                  ...
                  <div class="input-group">
                    ...
                    <select id="contact-budget" class="select-field">
                ...
                <button type="submit" id="submit-inquiry-btn" class="btn btn-primary btn-lg" style="width: 100%; margin-top: var(--space-3);">
